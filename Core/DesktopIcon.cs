...
/************************************************/
namespace Windows.DesktopIconController.Core
{
  public static partial class DesktopIcon
  {
    public static bool IsVisible
    {
      get
      {
        ...
        if (hWnd == IntPtr.Zero)
        {
          ...
          /************************************************/
          hWnd = DesktopIcon.FindWindowByLevel(DesktopIcon.GET_DESKTOP_WINDOW(), list);
        }
        /************************************************/
        if (hWnd == IntPtr.Zero)
        {
        ...
        return  1==1
        &&      hWnd != IntPtr.Zero
        &&      DesktopIcon.IS_WINDOW_VISIBLE(hWnd)
        ;
      }
    }
    /************************************************/
    public static bool Toggle()
    {
      ...
      /************************************************/
      DesktopIcon.SEND_MESSAGE(hWnd, DesktopIcon.WM_COMMAND, DesktopIcon.CMD_TOGGLE_DESKTOP_ICON, IntPtr.Zero);
      /************************************************/
    ...
    private static IntPtr FindWindowByLevel(IntPtr parent, Stack<KeyValuePair<string, string>> childLevel)
    {
      ...
      do
      {
        child = DesktopIcon.FIND_WINDOW_EX(parent, child, pair.Key, pair.Value);
        /************************************************/
